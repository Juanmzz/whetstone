...
2. [V2] **Verify before agreeing.** For any non-trivial technical claim — the human's, your
   own, or a **sub-agent's or tool's** — check the code/docs first, then answer. Say "let me
