...
rules:
  ...
  - glob: "docs/woz/SPEC.md"
    tier: strict
    reason: >-
      The schemas that propagate — signal, ADR, memory adapter, directory
      contract. Everything downstream is written against them, including files
      already living in other repositories.
  ...
  - glob: "docs/**"
    tier: light
    reason: >-
      Design and reference documentation. The propagating schema under docs/woz
      is claimed by a stricter rule above.
`;
